...
typedef struct  {
char *invalid_pmt, *time_out_pmt,* wel_pmt;
}
default_prompts;
...
patch_call_details_t patch;
//voicebot_details vb;
dynamic_ivr_details_t  dynamic_ivr;
...
//void handle_voicebot(switch_channel_t *channel, char *dsn, switch_mutex_t *mutex, call_details_t *call, char *path, char *custom_path);
