...
am_mod_cc_pbx_la_OBJECTS = mod_cc_pbx_la-mod_cc_pbx.lo \
	...
	mod_cc_pbx_la-cc_pbx_func.lo mod_cc_pbx_la-esl_evnt.lo
...
ACLOCAL = ${SHELL} /usr/src/bhati/freeswitch-1.10.10.-release/build/config/missing aclocal-1.13
AMQP_CFLAGS = 
AMQP_LIBS = 
AMRWB_CFLAGS = 
AMRWB_LIBS = 
...
AUTOCONF = ${SHELL} /usr/src/bhati/freeswitch-1.10.10.-release/build/config/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/bhati/freeswitch-1.10.10.-release/build/config/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/bhati/freeswitch-1.10.10.-release/build/config/missing automake-1.13
...
G7221_CFLAGS = 
G7221_LIBS = 
GETG729 = cd /usr/src/bhati/freeswitch-1.10.10.-release/libs && /bin/sh /usr/src/bhati/freeswitch-1.10.10/build/getg729.sh
GETLIB = cd /usr/src/bhati/freeswitch-1.10.10.-release/libs && /bin/sh /usr/src/bhati/freeswitch-1.10.10/build/getlib.sh
GETSOUNDS = /bin/sh /usr/src/bhati/freeswitch-1.10.10.-release/build/getsounds.sh
GREP = /usr/bin/grep
GUMBO_CFLAGS = 
GUMBO_LIBS = 
H2O_CFLAGS = 
...
MAGICK_CFLAGS = 
MAGICK_LIBS = 
MAKEINFO = ${SHELL} /usr/src/bhati/freeswitch-1.10.10.-release/build/config/missing makeinfo
MANIFEST_TOOL = :
MEMCACHED_CFLAGS =  
...
STRIP = strip
SWITCH_AM_CFLAGS = -I/usr/include/uuid   -I/usr/src/bhati/freeswitch-1.10.10.-release/src/include -I/usr/src/bhati/freeswitch-1.10.10.-release/src/include -I/usr/src/bhati/freeswitch-1.10.10.-release/libs/libteletone/src -fPIC -ffast-math -Werror -Wno-unused-result -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DCJSON_API_VISIBILITY=1 -DHAVE_VISIBILITY=1 -g -ggdb -DHAVE_OPENSSL
SWITCH_AM_CPPFLAGS = -I/usr/src/bhati/freeswitch-1.10.10.-release/src/include -I/usr/src/bhati/freeswitch-1.10.10.-release/src/include -I/usr/src/bhati/freeswitch-1.10.10.-release/libs/libteletone/src
SWITCH_AM_CXXFLAGS = -I/usr/src/bhati/freeswitch-1.10.10.-release/src/include -I/usr/src/bhati/freeswitch-1.10.10.-release/src/include -I/usr/src/bhati/freeswitch-1.10.10/libs/libteletone/src -fPIC -ffast-math -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DCJSON_API_VISIBILITY=1 -DHAVE_VISIBILITY=1
...
YAML_LIBS = 
ZCAT = /usr/bin/gunzip
abs_builddir = /usr/src/bhati/freeswitch-1.10.10.-release/src/mod/applications/mod_cc_pbx
abs_srcdir = /usr/src/bhati/freeswitch-1.10.10.-release/src/mod/applications/mod_cc_pbx
abs_top_builddir = /usr/src/bhati/freeswitch-1.10.10.-release
abs_top_srcdir = /usr/src/bhati/freeswitch-1.10.10.-release
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /usr/src/bhati/freeswitch-1.10.10.-release/build/config/install-sh
...
switch_builddir = /usr/src/bhati/freeswitch-1.10.10.-release
switch_srcdir = /usr/src/bhati/freeswitch-1.10.10.-release
...
include ./$(DEPDIR)/mod_cc_pbx_la-esl_evnt.Plo
...
mod_cc_pbx_la-esl_evnt.lo: esl_evnt.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_cc_pbx_la_CFLAGS) $(CFLAGS) -MT mod_cc_pbx_la-esl_evnt.lo -MD -MP -MF $(DEPDIR)/mod_cc_pbx_la-esl_evnt.Tpo -c -o mod_cc_pbx_la-esl_evnt.lo `test -f 'esl_evnt.c' || echo '$(srcdir)/'`esl_evnt.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/mod_cc_pbx_la-esl_evnt.Tpo $(DEPDIR)/mod_cc_pbx_la-esl_evnt.Plo
#	$(AM_V_CC)source='esl_evnt.c' object='mod_cc_pbx_la-esl_evnt.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_cc_pbx_la_CFLAGS) $(CFLAGS) -c -o mod_cc_pbx_la-esl_evnt.lo `test -f 'esl_evnt.c' || echo '$(srcdir)/'`esl_evnt.c
